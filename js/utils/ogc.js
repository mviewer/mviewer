...
export const appendParams = (uri, params) => {
    const keyParams = [];
...
export const getParamsFromOwsOptionsString = (owsOptionsString) => {
    if (owsOptionsString === undefined) {
        return undefined;
    }

    let params = {};
    let kvArray = owsOptionsString.split(",");
...
export const getCapUrl = (serviceUri, params) => {
