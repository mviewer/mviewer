    ...
    var _initMeasureTool = function () {
        ...
        var button = [
            '<button class="mv-modetools btn btn-default btn-raised" href="#"',
                ' onclick="mviewer.tools.measure.toggle();" id="measurebtn" title="Mesurer" tr="measure.button.main"',
        ...
        var buttonoptions = [
            '<div id="drawtoolsoptions" style="display:none;" class="btn-group btn-group-sm"',
                ...
                '<button  id="measurelinebtn" title="Mesure linéaire" tr="measure.button.line"',
                    ' onclick="mviewer.setTool(\'measure\', \'LineString\');" class="btn btn-default button-tools" >',
                    '<span class="glyphicon glyphicon-resize-small" aria-hidden="true"></span>',
                '</button>',
                '<button  id="measureareabtn" title="Mesure surfacique" tr="measure.button.surface" onclick="mviewer.setTool(\'measure\', \'Polygon\');"',
