...
mviewer.templates.layerControl = [
    '<li class="{{cls}}" data-layerid="{{layerid}}" data-title=" {{title}}">',
        '<div class="row layerdisplay-title" >',
            ...
            '</a>',
            '<a href="#" class="mv-layer-remove lang" aria-label="close" onclick="mviewer.removeLayer(this)" key-lang="Supprimer" title="Supprimer" ><span class="glyphicon glyphicon-trash"></span></a>',
        '</div>',
