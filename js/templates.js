    ...
    '<li class="{{cls}}" id="theme-layers-{{id}}" >',
        ...
        '{{#toggleAllLayers}}',
            '<div class="toggle-theme-layers">',
                '<span class="badge" title="Afficher/Masquer toutes les couches de la thématique">0/1</span>',
            '</div>',
        '{{/toggleAllLayers}}',
        '</a>',
...
mviewer.templates.layerControl = [
    '<li class="{{cls}}" data-layerid="{{layerid}}" data-title=" {{title}}">',
        '<div class="row layerdisplay-title" >',
            '<i class="mv-grip fas fa-grip-vertical" title="Déplacer"></i><a>{{title}}</a>',
            '{{#secure_layer}}',
            ...
            '</button>',
            '{{/secure_layer}}',
            '<a href="#" class="mv-layer-remove" aria-label="close" onclick="mviewer.removeLayer(this)" title="Supprimer" >',
            ...
            '<div class="row">',
                '<div class="col-md-12">',
                    '<div class="form-group form-group-opacity">',
                        '<label for="{{layerid}}-layer-opacity">Opacité</label>',
            ...
            '<div class="row">',
                '<div class="col-md-12">',
                    '<a data-layerid="{{layerid}}" class="layer-tooltip"',
                        ...
                        '<span class="state-icon far mv-unchecked"></span>Afficher les infobulles',
                        '<input type="checkbox" class="hidden" value="false">',
                    '</a>',
                '</div>',
            '</div>',
                ...
                '<div class="col-md-12">',
                    ...
                    '{{#metadata}}',
                        '<a href="#" role="button" id="{{layerid}}-layer-summary" tabindex="10" data-trigger="focus"',
                            ...
                            ' data-content="">',
                                '<span title="Afficher les informations" class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>',
                        '</a>',
                    '{{/metadata}}',
                    '</p>',
                '</div>',
