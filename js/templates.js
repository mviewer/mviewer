    ...
    '<div id="{{panel}}-selector">',
        '<div class="row">',
            '<div class="col-md-12">',
                ...
                '{{#layers}}',
                  '<div class="panel">',
                    '{{#firstlayer}}<div class="panel-heading mv-theme caret-toggle" id="dataToggleDiv" data-toggle="collapse" data-parent="#accordion" href="#accordion-{{panel}}-{{id}}" role="tab" id="heading-{{panel}}-{{id}}" data-layerid="{{layerid}}">{{/firstlayer}}',
                    '{{^firstlayer}}<div class="panel-heading mv-theme caret-toggle collapsed" id="dataToggleDiv" data-toggle="collapse" data-parent="#accordion" href="#accordion-{{panel}}-{{id}}" role="tab" id="heading-{{panel}}-{{id}}" data-layerid="{{layerid}}">{{/firstlayer}}',
