    ...
    '<li class="{{cls}}" id="theme-layers-{{id}}" >',
        ...
        '{{#toggleAllLayers}}',
            '<div class="toggle-theme-layers">',
                '<span class="badge" title="Afficher/Masquer toutes les couches de la thématique" tr="theme.display.layers">0/1</span>',
            '</div>',
        '{{/toggleAllLayers}}',
        '</a>',
...
mviewer.templates.layerControl = [
    '<li class="{{cls}}" data-layerid="{{layerid}}" data-title=" {{title}}">',
        '<div class="row layerdisplay-title" >',
            '<i class="mv-grip fas fa-grip-vertical" title="Déplacer" tr="theme.layers.move"></i><a>{{title}}</a>',
            '{{#secure_layer}}',
            ...
            '</button>',
            '{{/secure_layer}}',
            '<a href="#" class="mv-layer-remove" aria-label="close" onclick="mviewer.removeLayer(this)" title="Supprimer" tr="theme.layers.remove">',
            ...
            '<div class="row">',
                '<div class="col-md-12">',
                    '<div class="form-group form-group-opacity">',
                        '<label for="{{layerid}}-layer-opacity" tr="legend.label.opacity">Opacité</label>',
            ...
            '<div class="row">',
                '<div class="col-md-12">',
                    '<a data-layerid="{{layerid}}" class="layer-tooltip"',
                        ...
                        '<span class="state-icon far mv-unchecked"></span><div style="display:inline;" tr="legend.radio.tooltips">Afficher les infobulles</div>',
                        '<input type="checkbox" class="hidden" value="false">',
                    '</a>',
                '</div>',
            '</div>',
                ...
                '<div class="col-md-12">',
                    ...
                    '{{#metadata}}',
                        '<a href="#" role="button" id="{{layerid}}-layer-summary" tabindex="10" data-trigger="focus"',
                            ...
                            ' data-content="">',
                                '<span title="Afficher les informations" tr="theme.layers.infos" class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>',
                        '</a>',
                    '{{/metadata}}',
                    '</p>',
                '</div>',
            ...
            '<div class="row">',
                '<div class="col-md-12">',
                    '<div class="form-group form-group-analyses">',
                        '<label for="{{layerid}}-styles-selector" tr="style.control.analyses">Analyses</label>',
            ...
            '<div class="row">',
                '<div class="col-md-12">',
                    '<div class="form-group form-group-timer ">',
                        '<label for="{{layerid}}-layer-timefilter" tr="control.time.time">Temporalité</label>',
        ...
        '{{/timeControl}}',
            ...
            '</div>',
            '<a href="#" aria-label="Options" onclick="mviewer.toggleLayerOptions(this);" title="Options" tr="theme.layers.options" class="icon-options">',
                    ...
                    '{{#layers}}',
                        '<div  role="tabpanel" class="{{#firstlayer}}active in {{/firstlayer}}tab-pane" id="slide-{{panel}}-{{id}}" >',
                            ...
                            '{{#manyfeatures}}',
                                ...
                                '<span class="sr-only" tr="carousel.control.previous">Previous</span>',
                                '</a>',
                                '<a class="right carousel-control" href="#carousel-{{panel}}-{{id}}" ',
                                'role="button" data-slide="next">',
                                '<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>',
                                '<span class="sr-only" tr="carousel.control.next">Next</span>',
                                '</a>',
