    ...
    '<div id="{{panel}}-selector">',
        '<div class="row">',
            '<div class="col-md-12">',
                ...
                '{{#layers}}',
                  '<div class="panel">',
                    '<div class="panel-heading mv-theme collapsed" onclick="mviewer.toggleLayerOptions(this);" id="dataToggleDiv" data-toggle="collapse" data-parent="#accordion" href="#accordion-{{panel}}-{{id}}" role="tab" id="heading-{{panel}}-{{id}}" data-layerid="{{layerid}}">',
                      '<h4 class="panel-title text-right">',
                        '<a role="button" class="pull-left" aria-expanded="{{#firstlayer}}true{{/firstlayer}}{{^firstlayer}}false{{/firstlayer}}" aria-controls="accordion-{{panel}}-{{id}}">',
                          '{{name}}',
                         '</a>',
                        '{{#firstlayer}}<span class=" state-icon glyphicon glyphicon-chevron-up"></span>{{/firstlayer}}',
                        '{{^firstlayer}}<span class=" state-icon glyphicon glyphicon-chevron-down"></span>{{/firstlayer}}',
                      '</h4>',
                    '</div>',
