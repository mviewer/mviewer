var capabilitiesParser = (function () {
  ...
  var _addWmsInfosLayer = function (capa, xmlCapabilities, rawData) {
    ...
    const isWMS111 =
      xmlCapabilities.WMT_MS_Capabilities && capa.version == "1.1.1";
    ...
    if (isWMS111) {
      const layers =
        xmlCapabilities.WMT_MS_Capabilities[1].Capability.Layer.Layer;
...
var addlayers = (function () {
   ...
   * paging parameters.
   */
  var _pagingInfos = { pageSize: 100, currentPage: 0, nbPages: 1 };
  ...
  var _showLayerList = function (layerList, parentDiv) {
    ...
    $.each(layerList, function (id, layer) {
      ...
      let rowClass =
        layer.Layer && layer.Layer.length > 0 ? "" : "layer-result-row";
