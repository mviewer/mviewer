mviewer.customControls.profile = (function () {
  ...
  var _initChart = function () {
    ...
    var chartPanel = [
      '<div class="profile-addon panel-graph mt-2" style="height: ' +
        height[target] +
        ';">',
        ...
        callbacks: {
          label: function (tooltipItem, data) {
            ...
            return [
              ...
              "altitude : " +
                parseInt(data.datasets[0].data[tooltipItem.index]).toLocaleString() +
                " m",
            ];
          },
        },
  ...
  var _updateChart = function (dataxml) {
    ...
    if (response.Status.ProcessSucceeded) {
      ...
      mviewer.alert(
        response.Status.ProcessFailed.ExceptionReport.Exception.ExceptionText,
        "alert-info"
      );
    }
