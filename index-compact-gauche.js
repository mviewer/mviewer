...
$(document).ready(function () {
    ...
    if (!(config.config)) $.extend(config,$.parseJSON('{"config" : "config/default.xml"}'));

    /* Un style par défaut pour le panneau des fonds de plan */
    if (!(config.blstyle)) $.extend(config,$.parseJSON('{"blstyle" : "config"}'));
	...
	<div id="main" data-role="page" style="opacity: 0;">		
		...
		<div id="themepanel" data-role="panel" data-position="left"  data-display="overlay" data-theme="b" data-dismissible="false" data-swipe-close="false">			
			<div id="panel-header">
                 ...
                 <!--<a href="#" id="panel-closer" data-role="button" data-icon="delete" data-iconpos="notext" data-theme="b" data-inline="true" onclick="$('#themepanel').panel('close');" >Fermer ce panneau</a>-->
            </div>
            <div class="ui-grid-a">
            ...
            <div id="panel-footer">
                <div id="mentionstoolbar">
                    <a href="http://kartenn.region-bretagne.fr/mviewer/doc/aide_kartenn.pdf"  
                ...
                <!--<img src="img/panel-footer.png" alt="Les 9 missions principales de la région Bretagne"/>-->            </div>
...
<script src=lib/compact-gauche.js></script>
</body>
</html>
