...
mviewer.customLayers.ocs56.style1 = function (feature, resolution) {
    ...
    feature.getProperties()["label"] = mviewer.customLayers.ocs56.classification_couverture[level][ref].title;
    ...
    stroke: new ol.style.Stroke({
      ...
      width: mviewer.customLayers.ocs56.classification_couverture[level][ref].strokewidth + 0.001
    })
  });
    return style;
};
...
mviewer.customLayers.ocs56.style0 = function (feature, resolution) {
    ...
    if (mviewer.customLayers.ocs56.classification_usage[level][ref]) {
        feature.getProperties()["label"] = mviewer.customLayers.ocs56.classification_usage[level][ref].title;
