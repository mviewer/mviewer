mviewer.customLayers.inventaire = (function () {
    ...
    _featurescount = null;
    _searchinfields = [ "denomination", "datation_principale", "materiaux_murs", "materiaux_toit","materiaux_mobilier" ];
    ...
    var _elsLoader = function(extent, resolution, projection) {
        ...
        var url = "https://ows.region-bretagne.fr/els/_search?index=etude_patrimoine_simple,recensement_patrimoine&track_total_hits=true&size=10000";
