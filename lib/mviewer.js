...
mviewer = (function () {
    ...
    var _clearTools = function () {
        ...
        $('#measurelinebtn').removeClass('btn-primary').addClass("btn-default");
        $("#measurebtn").removeClass("btn-primary").addClass("btn-default");
        $('#measureareabtn').removeClass('btn-primary').addClass("btn-default");
    ...
    return {
        ...
        setTool: function (tool, origin) {
            if (($("#measurebtn").hasClass("btn-primary")) && (origin === 'measurebtn')) {              
                tool = 'info';
            }
            _deactivateTools();
            _clearTools();
            ...
            case 'measureline':
                ...
                $('#measurelinebtn').addClass('btn-primary');
                $("#measurebtn").addClass("btn-primary");
                break;           
            case 'measurearea':
                 $("#drawtoolsoptions").show();
                 _addMeasureInteraction('Polygon');
                 $('#measureareabtn').addClass('btn-primary');
                 $("#measurebtn").addClass("btn-primary");
                break;
            }            
        },
        ...
        addLayer: function (layer) {
            ...
            var item = new TPLLayercontrol2(layer.layerid, layer.title, layer.legendurl, 
					layer.queryable, layer.checked, layer.crossorigin, layer.searchable).html();
             $("#layers-container").append(item);
             _getLayerByName(layer.title).setVisible(true);
        ...
        toggleLayer: function (el) {
            ...
            if ( li.find("input").val() === 'false' ) {
                ...
                var el = $(".mv-layer-options[data-layerid='"+li.data("layerid")+"']")
