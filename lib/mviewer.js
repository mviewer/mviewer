...
mviewer = (function () {
    ...
    /**
     * Property: _search_in_localities
     * Boolean. Enables the search in features
     */
    var _search_in_localities = true;
    
    /**
     * Property: _search_in_features
     * Boolean. Enables the search in features
     */
    var _search_in_features = false;
    ...
    var _mapChange = function (e) {
        ...
        if (_elasticSearchUrl && _search_in_features && $("#searchfield").val()) {
    ...
    return {     
        ...
        init: function (xml) {
           // try {
                ...
                _marker = new ol.Overlay({ positioning: 'bottom-center', element: $("#marker"), stopEvent: false}); 
