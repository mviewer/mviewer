...
mviewer = (function () {
    ...
    return {
            ...
            var item = new TPLLayercontrol2(layer).html();
             ...
             if (layer.timefilter && (layer.timecontrol === 'slider' || layer.timecontrol === 'slider-range')) {
                    ...
                    if (layer.timecontrol === 'slider') {                         
                          ...
                          $(".mv-time-player").click(function(e){
             ...
             if (oLayer.styles) {                
                ...
                $('.mv-layer-details[data-layerid="'+layer.layerid+'"] .layerdisplay-subtitle .selected-sld').text(selectCtrl.options[selectCtrl.selectedIndex].label);
             ...
             if (oLayer.attributefilter && oLayer.layer.getSource().getParams()['CQL_FILTER']) {                
                ...
                $('.mv-layer-details[data-layerid="'+layer.layerid+'"] .layerdisplay-subtitle .selected-attribute').text(activeAttributeValue);  
             }
        ...
        setLayerStyle: function (layerid, style, selectCtrl) {
            ...
            _source.changed();
            $('.mv-layer-details[data-layerid="'+layerid+'"] .layerdisplay-subtitle .selected-sld').text(selectCtrl.options[selectCtrl.selectedIndex].label);
         ...
         setLayerAttribute: function (layerid, attributeValue, selectCtrl) {            
            ...
            _source.changed();
            $('.mv-layer-details[data-layerid="'+layerid+'"] .layerdisplay-subtitle .selected-attribute').text(selectCtrl.options[selectCtrl.selectedIndex].label);            
        },
