    ...
    return {
        ...
        init: function (xml) {
           // try {                
                ...
                if (applicationOverride.attr("panelfooterimage")) {                    
                    $('#panel-footer').css('background-image', 'url("' + applicationOverride.attr("panelfooterimage") + '")');
                }
                if (applicationOverride.attr("panelfooterheight")) {                    
                    $('#panel-footer').css('height', applicationOverride.attr("panelfooterheight"));
                }
