                ...
                if (layer.timevalues) {
                    ...
                    ticks = _createPseudoTicks(layer.timevalues);
                     ...
                     $("#"+layer.layerid+"-layer-timefilter")
                        ...
                        .slider({value:parseInt(ticks_labels[ticks_labels.length -1]), tooltip: 'show',
                            tooltip_position: 'bottom', ticks_labels: ticks_labels,
                            ticks: ticks, step:1, 
                            formatter: function(val) {
                              return parseInt(ticks_labels[val]);
                            }
                         });                        
                        $("#"+layer.layerid+"-layer-timefilter").on('change', function(data){                        
                            mviewer.setLayerTime( layer.layerid, parseInt(ticks_labels[data.value.newValue]) );
                        });
                } else {
