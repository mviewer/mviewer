    ...
    return {
        ...
        legendSize(img) {
            if (img.width > 250) {
                ...
                $(img).parent().append('<span onclick="mviewer.popupPhoto(this.parentElement.getElementsByTagName(\'img\')[0].src)" class="text-big-legend"><span>Agrandir la légende</span></span>');                
            }
        }
