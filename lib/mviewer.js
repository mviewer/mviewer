            ...
            var callback = function (result) {
                ...
                $.each(featureInfosHtml, function (panel, value) {     
                    if(featureInfosHtml[panel].length>0){ 
                        ...
                        if ($("#"+panel+" .popup-content iframe").length === 1) {
                            $("#"+panel+" .popup-content").append(['<div class="mv-iframe-indicator" >',
                                 '<div class="loader">Loading...</div>',
                             '</div>'].join(""));
                        };
                        $("#"+panel+" .popup-content iframe").on('load',function () {
                            $("#"+panel+" .popup-content .mv-iframe-indicator").hide();
                        });
    ...
    return {
        ...
        addLayer: function (layer) {            
            var item = new TPLLayercontrol2(layer).html();
             ...
             if (layer.type === 'hook' && layer.tooltip && layer.tooltipenabled) {
