    ...
    return {
        ...
        init: function (xml) {          
                ...
                if ((applicationOverride.attr("stats") === "true" ) && applicationOverride.attr("statsurl")) {
                    $.get("../ws/kartenn/log.php?app=" + document title); 
                }                 
        ...
        addLayer: function (layer) {            
            var item = new TPLLayercontrol2(layer).html();
             ...
             if (oLayer.styles || (oLayer.attributefilter && oLayer.attributestylesync)) {                
                var activeStyle = oLayer.layer.getSource().getParams()['STYLES'];
                if (oLayer.attributefilter && oLayer.attributestylesync) {
                    //Application du 1er sous-style attributaire
                    this.setLayerStyle(layer.layerid, activeStyle, $("#"+layer.layerid+"-styles-selector")[0]);
        ...
        setLayerStyle: function (layerid, style, selectCtrl) {
            ...
            _source.changed();
            //var styleLabel = selectCtrl.options[selectCtrl.selectedIndex].label;
            var styleLabel = $(selectCtrl).find("option[value='"+styleBase+"']").attr("label");
