...
mviewer = (function () {
    ...
    _doToggle = function () {
      _ol3d.setEnabled(!_ol3d.getEnabled());
    };

    _init3D = function () {
      _ol3d = new olcs.OLCesium({map: _map});
      var scene = _ol3d.getCesiumScene();
	...
	_resetMapToNorth = function(map, ol3d) {
    ...
    return {
        ...
        zoomOut: function () {            
             ...
             var currentResolution = v.getResolution();
             _map.beforeRender(ol.animation.zoom({
                    resolution: currentResolution,
                    duration: 500,
                    easing: ol.easing.easeOut
             }));            
             var newResolution = v.constrainResolution(currentResolution, -1);
        ...
        init: function (xml) {
           // try {
                ...
                _marker = new ol.Overlay({ positioning: 'bottom-left', element: $("#els_marker")[0], stopEvent: false}); 
