    ...
    var _initDataList = function () {
		...
		$( ".togglelayer" ).each(function() {		
			$( this ).bind( "change",function() {			
				this.toggleOverLayer(this.name);
			});
		});
		...
		$( ".opacity-btn" ).each(function() {		
			$( this ).bind( "click",function() {
				...
				$("#opacityLayer-slider").val(this.getLayerOpacity(this.name)).slider("refresh");
		...
		$( ".metadata-btn" ).each(function() {		
			$( this ).bind( "click",function() {
				var md = this.getLayerMetadata(this.name);
