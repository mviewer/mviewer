mviewer = (function () {
    ...
    var _popup = document.getElementById('popup');
     ...
     /**
     * Property: _popupContent
     */

    var _popupContent = document.getElementById('popup-content');
    
     /**
     * Property: _popupCloser
     */
    ...
    var _overlay = new ol.Overlay({element: _popup});
    ...
    var createContentHtml = function (features, title, maxheight) {
        var html = '';
        html += '<div id="popuptitle" class="popover-title"><strong>' + title + '</strong><button type="button" id="popupclose" onclick="mviewer.closePopup(event);" class="close">&times;</button></div>';        
        if (maxheight) {
                ...
                _map = new ol.Map({
                    ...
                    controls: ol.control.defaults().extend([
                        ...
                        new ol.control.ZoomToExtent({
                              //extent: options.attr("extent").split(",")                              
                            })
                      ]),
                    /*layers: [
                        new ol.layer.Tile({
