    ...
    var _pointerMoveHandler = function(evt) {
      ...
      if (_sketch) {
            ...
            if (geom instanceof ol.geom.Polygon) {
                helpMsg = 'Clicquer pour poursuivre le polygone';
            } else if (geom instanceof ol.geom.LineString) {
                helpMsg = 'Clicquer pour poursuivre la ligne';
            }
      }
        ...
        var visibleLayers = [];
            ...
            var callback = function (result) {               
            	...
            	if(featureInfosHtml.length>0){                    
                    ...
                    //$("#popup-content").append('<div data-role="tabs" id="tabs"><div id="selector" data-role="navbar" > <ul id=ulnav></ul></div></div>');                    
                    ...
                    for(i=1;i<=idcarrousel;i++){
                        ...
                        //$('#slide-'+i).append('<p class="counter-slide"></p>');
                    }                    
                    $( "#selector" ).tabs();
    ...
    var _parseWMCResponse = function (response, wmcid) {
        ...
        $(wmc).find('LayerList > Layer').each(function() {        
            ...
            if ($(this).attr('queryable')=='1') {
                ...
                if ($(this).find("MinScaleDenominator") || $(this).find("MaxScaleDenominator")) {
                    oLayer.scale = {};
                    if ($(this).find("MinScaleDenominator")) {
                        oLayer.scale.min = parseInt($(this).find("MinScaleDenominator").text());
                    }
                    if ($(this).find("MaxScaleDenominator")) {
                        oLayer.scale.max = parseInt($(this).find("MaxScaleDenominator").text());
                    }
                }
