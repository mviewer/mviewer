            ...
            //NO GROUPS
                ...
                $.each(reverse_layers.reverse(), function (id, layer) {
                    htmlListLayers += new TPLLayercontrol(layer.id, layer.name, layer.legendurl, 
                        layer.queryable, layer.checked, crossorigin, layer.searchable, layer.opacity, layer.styles, layer.stylesalias, layer.timefilter, layer.timeinterval, layer.timecontrol, layer.timemin, layer.timemax, layer.attribution, layer.metadata).html();
                });
    ...
    return {
        ...
        addLayer: function (layer) {            
            var item = new TPLLayercontrol2(layer.layerid, layer.title, layer.legendurl, 
					layer.queryable, layer.checked, layer.crossorigin, layer.searchable, _overLayers[layer.layerid].layer.getOpacity(), layer.styles, layer.stylesalias, layer.timefilter, layer.timeinterval, layer.timecontrol, layer.timemin, layer.timemax, layer.attribution, layer.metadata).html();
