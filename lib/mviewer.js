mviewer = (function () {
    ...
    var _initDataList = function () {
		...
		$.each(_allLayersGroups, function (id, group) {
			var htmlListLayers = ""
			$.each(_allLayersGroups[group.id].layers, function (id, layer) {
        ...
        init: function (xml) {
            try {
                ...
                $(maps).each(function () {
					...
					_allLayersGroups[mapid].collapsed = $(this).parent().attr("collapsed");
                    ...
                    $(layersXml.get().reverse()).each(function () {
                        ...
                        _allLayersGroups[mapid].layers[layerId] = themeLayers[layerId];
