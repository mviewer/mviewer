mviewer = (function () {
    ...
    var _initThemes = function () {
        ...
        $('#themeaccordeon').on('expand', function () {
            //$('#themelist').jScrollPane();
        });

        $('#themeaccordeon').on('collapse', function () {
            //$('#themelist').jScrollPane();
        });
    };
    ...
    return {
        ...
        getLegendUrl: function (layer) {
            return layer.url + '?service=WMS&request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=' + layer.id + '&style=' + layer.style + '&legend_options=fontName:Times%20New%20Roman;fontAntiAliasing:true;fontColor:0x222222;fontSize:12;dpi:96';
        },
