        ...
        init: function (xml) {
           // try {                
                ...
                if (applicationOverride.attr("panelfooterheight") && applicationOverride.attr("panelfooterimage")) {                    
                    $('#panel-footer').css('background-image', 'url("' + applicationOverride.attr("panelfooterimage") + '")').css('height', applicationOverride.attr("panelfooterheight"));
                    $("#datalist,#mapinfos").css('bottom', applicationOverride.attr("panelfooterheight"));
                }
                //hack css modif
