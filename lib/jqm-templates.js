...
TPLBackgroundlayerstoolbar.prototype.init = function(){
	...
	if (this.option === "gallery") {
        $("#backgroundlayersbtn").remove();
		$("#backgroundlayerstoolbar").append(['<div class="bglt-btn" onclick="mviewer.bgtoogle();">',
    ...
    if (this.timefilter) {
        time_selector = ['<div class="row">',
                        ...
                        '<div class="form-group form-group-timer ">',
                              ...
                              '<input type="text" min="'+this.timemin+'" max="'+this.timemax+'"  id="'+this.layerid+'-layer-timefilter"',
                                    ' name="'+this.layerid+'" data-provide="slider" data-slider-value="'+this.timemax+'" data-slider-max="'+this.timemax+'"',
                                    ' data-slider-min="'+this.timemin+'" data-slider-step="1" onchange="mviewer.setLayerTime(this.name, this.value)">',                              
                          '</div>',
                          '</div>',
                         '</div>'].join (" ");
    }
    if (this.styles && this.styles != "undefined") {
        ...
        styles_selector = ['<div class="row">',
                        ...
                        '<div class="form-group form-group-analyses">',
                              ...
                              ' onchange="mviewer.setLayerStyle(this.name ,this.value);">',
                              options.join(" "),
                              '</select>',
                          '</div>',
                          '</div>',
