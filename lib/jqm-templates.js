...
function TPLLayercontrol(layerid, title, legendurl, queryable, checked, crossorigin, searchable, opacity, styles, stylesalias, timefilter, timeinterval, timecontrol, timemin, timemax, attribution, metadata, customcontrols){   
...
TPLLayercontrol.prototype.html = function(){                    
     ...
     ' data-legendurl="'+this.legendurl+'" data-checked="'+this.checked+'" data-crossorigin="'+this.crossorigin+'" data-timefilter="'+this.timefilter+'"  data-timeinterval="'+this.timeinterval+'"  data-timecontrol="'+this.timecontrol+'"  data-timemin="'+this.timemin+'"  data-timemax="'+this.timemax+'" data-styles="'+this.styles+'" data-stylesalias="'+this.stylesalias+'" data-customcontrols="'+this.customcontrols+'" data-opacity="'+this.opacity+'" data-searchable="'+this.searchable+'" >',
     '<a href="#" ><span class="state-icon fa mv-layer-unchecked"></span>',     
					this.title,	
					'<input type="checkbox" class="hidden" value="false" ></a></li>'].join( " ");
}

function TPLLayercontrol2(layerid, title, legendurl, queryable, checked, crossorigin, searchable, opacity, styles, stylesalias, timefilter, timeinterval, timecontrol, timemin, timemax, attribution, metadata, customcontrols){   
   this.layerid = layerid;
   this.title = title;   
   this.queryable = queryable;
   this.legendurl = legendurl;
    ...
    if (this.timefilter) {
        time_selector = ['<div class="row">',
                        ...
                        '<div class="form-group form-group-timer ">',
                              ...
                              '<input class="mv-slider-timer" type="date" min="'+this.timemin+'" max="'+this.timemax+'"  id="'+this.layerid+'-layer-timefilter" name="'+this.layerid+'" data-provide="slider" data-slider-value="'+this.timemax+'" data-slider-max="'+this.timemax+'" data-slider-min="'+this.timemin+'" data-slider-step="1" onchange="mviewer.setLayerTime(this.name, this.value)">',                              
                          '</div>',
                          '</div>',
                         '</div>'].join (" ");
    }
                           ...
                           '<div class="row">',
                            '<div class="col-md-12">',
                             ' <div class="form-group form-group-opacity">',
                                ...
                                '<input type="text" class="mv-slider" id="'+this.layerid+'-layer-opacity" name="'+this.layerid+'" value="'+this.opacity+'" data-provide="slider" data-slider-value="'+this.opacity+'" data-slider-max="1" data-slider-min="0" data-slider-step=".1" onchange="mviewer.changeLayerOpacity(this.name, this.value)">',
                              '</div>',                      
                            '</div>',
                            '</div>',
                            attribution_text,
