...
function TPLLayercontrol(layerid, title, legendurl, queryable, checked, crossorigin, searchable, opacity, styles, stylesalias, timefilter, timeinterval, timecontrol, timemin, timemax, attribution, metadata){   
...
TPLLayercontrol.prototype.html = function(){                    
     ...
     ' data-legendurl="'+this.legendurl+'" data-checked="'+this.checked+'" data-crossorigin="'+this.crossorigin+'" data-timefilter="'+this.timefilter+'"  data-timeinterval="'+this.timeinterval+'"  data-timecontrol="'+this.timecontrol+'"  data-timemin="'+this.timemin+'"  data-timemax="'+this.timemax+'" data-styles="'+this.styles+'" data-stylesalias="'+this.stylesalias+'" data-opacity="'+this.opacity+'" data-searchable="'+this.searchable+'" >',
     '<a href="#" ><span class="state-icon fa mv-layer-unchecked"></span>',     
					this.title,	
					'<input type="checkbox" class="hidden" value="false" ></a></li>'].join( " ");
}

function TPLLayercontrol2(layerid, title, legendurl, queryable, checked, crossorigin, searchable, opacity, styles, stylesalias, timefilter, timeinterval, timecontrol, timemin, timemax, attribution, metadata){   
   this.layerid = layerid;
   this.title = title;   
   this.queryable = queryable;
   this.legendurl = legendurl;
