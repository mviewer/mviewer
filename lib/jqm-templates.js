...
TPLLayercontrol2.prototype.html = function(){
    ...
    if (this.type === 'hook' && this.tooltip) {
        tooltip_control = '<a data-layerid="'+this.layerid+'" class="layer-tooltip" onclick="mviewer.toggleTooltip(this);" id="'+this.layerid+'-layer-tooltip" href="#"><span class="state-icon fa mv-unchecked"></span>Tooltip<input type="checkbox" class="hidden" value="false"></a>';
    }
    ...
    if (this.attributefilter && this.attributevalues != "undefined" && this.attributefield != "undefined") {
        ...
        if (this.attributefilterenabled === false) {
            options_attributes.push('<option label="Tout" value="all">Tout</option>');
        }
