...
function TPLLayercontrol(layerid, title, legendurl, queryable, checked, crossorigin){   
	...
	return  ['<li data-layer="'+this.layerid+'" data-theme="a" data-icon="false"><a href="#">',
						...
						'<label for="checkbox-mini-'+this.layerid+'">',
							'<table style="width:100%;" >',
								'<tbody>',
									'<tr>',
										'<td><img '+this.crossorigin+' id="legend-'+this.layerid+'" src="'+this.legendurl+'" class="mv-legend"></td>',
