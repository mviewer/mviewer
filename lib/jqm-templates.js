									...
									'<tbody>',
										'<tr>',
											...
											'<td><div data-role="controlgroup" data-type="horizontal" data-mini="true" class="ui-btn-right" style="float:right;">',
												'<a class="opacity-btn" id ="opacity-btn-'+this.layerid+'" name="'+this.layerid+'" href="#" data-role="button" data-iconpos="notext" data-icon="gear" data-theme="a">Opacité de la couche</a>',
												'<a class="metadata-btn" id="metadata-btn-'+this.layerid+'" name="'+this.layerid+'" href="#" data-role="button" data-iconpos="notext" data-icon="grid" data-theme="a">Plus d\'information sur cette couche de données</a>',												
											'</div></td>',		
										 '</tr>',
									'</tbody>',
							 '</table>',
