...
function TPLLayercontrol(layerid, title, legendurl, queryable, checked, crossorigin, searchable, opacity, styles, timefilter, attribution){   
...
function TPLLayercontrol2(layerid, title, legendurl, queryable, checked, crossorigin, searchable, opacity, styles, timefilter, attribution){   
   this.layerid = layerid;
   this.title = title;   
   this.queryable = queryable;
   this.legendurl = legendurl;
    ...
    if (this.timefilter) {
        time_selector = ['<div class="row">',
                        ...
                        '<div class="form-group">',
                              ...
                              '<input type="month" class="" id="'+this.layerid+'-layer-timefilter" name="'+this.layerid+'" onchange="mviewer.setLayerTime(this.name, this.value)">',                              
                          '</div>',
                          '</div>',
                         '</div>'].join (" ");
    }
