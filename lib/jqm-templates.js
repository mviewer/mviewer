...
TPLLayergroup.prototype.html = function(){
	return ['<div data-theme="b" data-role="collapsible" data-collapsed="'+this.collapsed+'">',
						'<h2>'+this.title+'<a class="theme-layers-btn" id="theme-layers-'+this.id+'" data-status="0" data-action="true" data-mvtheme="'+this.id+'" data-inline="true" data-mini="true" data-role="button" data-icon="eye"></a></h2>',    
